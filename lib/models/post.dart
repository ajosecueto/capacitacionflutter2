import 'package:capacitacionflutter2/models/owner.dart';
...
class Post {
    ...
    Post({this.by_shared, this.commented, this.count_comment, this.count_like, this.count_shared, this.date, this.id, this.is_influencer, this.last_name, this.liked, this.message, this.name, this.owner, this.owner_shared, this.owner_shared_id, this.person_type, this.photo, this.photo_owner_shared, this.shared, this.status, this.type_post, this.url, this.user_id, this.username, this.verb});
